          ...
          <tr>
            <td style="width:`+ width + `;">
              <table id='tabla_IO' class='table table-borderless'>
                ...
                <tr><th> Outlet Temperature </td><td> <span class='intar-decimal'>Pb_T_impulsion/10/0/1/5</span> &degC </td></tr>
                <tr><th> Set Point </td><td> <span class='intar-decimal'>SET_GLICOL/10/0/1/5</span> &degC </td></tr>
              </table>
            </td>
            <td style="width:`+ width + `;">
              <table id='tabla_IO' class='table table-borderless'>
                ...
                <tr><th> Alarm </th><td><span class='intar-bool'>ALARMA/<span style='color:blue;'>OFF</span>/<span style='color:red;'>ON</span>/10</span> </td></tr>
                <tr><th> Warning </td><td><span class='intar-bool'>WARNING/<span style='color:blue;'>OFF</span>/<span style='color:red;'>ON</span>/10</span> </td></tr>
                <tr><th> Cooling </th><td><span class='intar-bool'>COMPRESOR/<span style='color:blue;'>OFF</span>/<span style='color: red;'>ON</span>/10</span> </td></tr>
              </table>
            </td>
            <td style="width:`+ width + `;">
              <table id='tabla_IO' class='table table-borderless'>
                <thead><tr><th colspan='2' class="text-center"> Outputs </th></tr></thead>
                <tr><th> Flow-switch </td><td><span class='intar-bool'>DI_flow_switch/<span style='color:blue;'>OFF</span>/<span style='color:red;'>ON</span>
                <tr><th> Pump1 </th><td><span class='intar-bool'>RELE_BOMBA1/<span style='color:blue;'>OFF</span>/<span style='color: red;'>ON</span>/10</span> </td></tr>
                <tr><th> Pump2 </td><td><span class='intar-bool'>RELE_BOMBA2/<span style='color:blue;'>OFF</span>/<span style='color: red;'>ON</span>/10</span> </td></tr>
              </table>
            </td>`;
      ...
      html +=
        `<td style="width:` + width + `;">
          <table id='tabla_IO' class='table table-borderless'>
            ...
            <tr><th> Suction Pressure Pump</td><td> <span class='intar-decimal'>Pb_P_aspi_pump/10/0/1/5</span> bar </td></tr>
            <tr><th> Delivery Pressure Pump</td><td> <span class='intar-decimal'>Pb_P_impu_pump/10/0/1/5</span> bar </td></tr>
      ...
      html +=
        `<td style="width:` + width + `;">
          <table id='tabla_IO' class='table table-borderless'>
            ...
            <tr><th> Suction Pressure Pump</th><td> <span class='intar-decimal'>Pb_P_aspi_pump2/10/0/1/5</span> bar </td></tr>
            <tr><th> Delivery Pressure Pump</th><td> <span class='intar-decimal'>Pb_P_impu_pump2/10/0/1/5</span> bar </td></tr>
